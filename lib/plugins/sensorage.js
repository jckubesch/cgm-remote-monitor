...
function init(ctx) {
  ...
  sage.getPrefs = function getPrefs(sbx) {
    return {
      info: sbx.extendedSettings.info || times.days(9).hours
      , warn: sbx.extendedSettings.warn || (times.days(10).hours - 4)
      , urgent: sbx.extendedSettings.urgent || (times.days10).hours - 2)
